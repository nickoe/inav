...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH1, PB4,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S3   UP1-2   D(1, 4, 5)
    DEF_TIM(TIM3, CH2, PB5,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S4   UP1-2   D(1, 5, 5)
