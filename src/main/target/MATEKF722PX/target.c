...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH3, PB0,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S5   UP1-2   D(1, 7, 5)
    DEF_TIM(TIM3, CH4, PB1,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S6   UP1-2   D(1, 2, 5)

    DEF_TIM(TIM2, CH3, PB10,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S7   UP1-7   D(1, 1, 3)
    DEF_TIM(TIM2, CH4, PB11,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 1),   // S8   UP1-7   D(1, 6, 3)

    DEF_TIM(TIM4, CH1, PB6,   TIM_USE_FW_SERVO, 0, 0),   // S9   UP1-6   D(1, 0, 2)
    DEF_TIM(TIM4, CH2, PB7,   TIM_USE_FW_SERVO, 0, 0),   // S10  UP1-6   D(1, 3, 2)
